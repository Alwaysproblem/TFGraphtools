...
if __name__ == "__main__":
  ...
  parser.add_argument("-m", "--model", dest="model_path", required=True, type=str)
  parser.add_argument("-bs", "--batch-size", dest="batch_size", type=int, default=1)
  parser.add_argument("-ipus", "--num-of-ipus", dest="num_ipus", type=int, default=1)
  parser.add_argument("-ps", "--pipeline-stages", dest="pipeline_stages", type=int, default=0)
  parser.add_argument("-ths", "--threads", dest="threads", type=int, default=1)
  parser.add_argument("-i", "--iterations", dest="iterations", type=int, default=100)
